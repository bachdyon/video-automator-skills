...
```bash
python skills/video-render-plan-builder/scripts/build_render_plan.py build \
...
python skills/video-render-plan-builder/scripts/build_render_plan.py validate \
