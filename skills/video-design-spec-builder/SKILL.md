...
- Chạy script:
  - `python skills/video-design-spec-builder/scripts/upload_video_to_gemini.py --video-path /path/to/video.mp4 --env-file .env --model gemini-3-flash-preview`
  - Có thể override fallback chain:
    - `python skills/video-design-spec-builder/scripts/upload_video_to_gemini.py --video-path /path/to/video.mp4 --env-file .env --model gemini-3-flash-preview --fallback-models gemini-3-flash-preview,gemini-2.5-pro,gemini-2.5-flash`
